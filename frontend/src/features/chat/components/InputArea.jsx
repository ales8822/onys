        ...
        <div className="sticky bottom-0 z-30 w-full pointer-events-none">
            ...
            <div className="w-full bg-gradient-to-t from-app-bg via-app-bg/95 to-transparent pb-6 pt-10 px-6">
                ...
                <div className="max-w-4xl mx-auto pointer-events-auto">
                    <div className="bg-[#1a1a1a] border border-gray-700 rounded-xl p-0 flex flex-col gap-0 shadow-2xl overflow-visible relative">

                        {/* Agent Switcher & Upload Bar Header */}
                        <div className="flex items-center justify-between px-3 pt-2 border-b border-gray-800/50 pb-2">
