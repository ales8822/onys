// frontend/src/features/chat/components/InputArea.jsx
// This handles the input area, file uploads, and footer stats.
...
export default function InputArea({ 
  ...
  return (
    <div className="sticky bottom-0 z-30 w-full px-6 pb-6 pt-2 pointer-events-none">
       <div className="max-w-4xl mx-auto bg-gradient-to-t from-app-bg via-app-bg/95 to-transparent pt-4 pointer-events-auto">
